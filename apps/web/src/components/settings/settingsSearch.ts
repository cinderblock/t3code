...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  {
    id: "preview-external-links",
    // Worded around "leaving the site" rather than "external links" so the
    // integrations "Open links in" setting stays the top hit for that query.
    title: "Off-site links in the preview browser",
    to: "/settings/general",
    searchTerms: ["preview browser navigate away leave site system browser popup"],
  },
  {
