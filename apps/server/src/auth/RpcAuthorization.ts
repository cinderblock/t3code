...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.vcsGraphSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.vcsWorktreeChanges]: AuthOrchestrationReadScope,
  ...
  // Fork-only RPCs (usage meters, queued messages). Upstream moved scopes out of
  // ws.ts into this typed record, where a missing entry is a compile error;
